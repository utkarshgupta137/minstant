...
impl Instant {
    ...
    /// ```
    pub fn now() -> Instant {
        Instant(crate::tsc_now::current_cycle())
    }
    ...
    pub fn checked_duration_since(&self, earlier: Instant) -> Option<Duration> {
        Some(Duration::from_nanos(
            (self.0.checked_sub(earlier.0)? as f64 * crate::tsc_now::nanos_per_cycle()) as u64,
        ))
    }
...
impl Anchor {
    ...
    pub fn new() -> Anchor {
        ...
        let cycle = crate::tsc_now::current_cycle();
        let unix_time_ns = unix_time
